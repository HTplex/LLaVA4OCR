# LLaXA: using LLaVA methodology to crack many VL tasks.

## FaceLLaVA

processed face trained llava

## LLaFA: 

Phase 1: only pre-training step of llava, use as translation, skip instruction tune step
Phase 2: add instruction tune step to do infomation extraction capabilities
...
deepspeed llava/train/train_mem.py \
    ...
    --version plain \
    --tune_mm_mlp_adapter True  \ # pretrain, freeze LM
